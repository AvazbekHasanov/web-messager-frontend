      ...
      <div class="grid md:grid-cols-3 items-center shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-xl overflow-hidden max-w-4xl">
        <div class="max-md:order-1 flex flex-col justify-center space-y-16 max-md:mt-16 min-h-full bg-gradient-to-r from-gray-900 to-gray-700 lg:px-8 px-4 py-4">
          <div>
            ...
            <p class="text-[13px] text-gray-300 mt-3 leading-relaxed dark:text-gray-100">Welcome to our registration page! Get started by creating your account.</p>
          </div>
          <div>
            <h4 class="text-white text-lg font-semibold dark:text-gray-100">Simple & Secure Registration</h4>
            <p class="text-[13px] text-gray-300 mt-3 leading-relaxed dark:text-gray-100">Our registration process is designed to be straightforward and secure. We prioritize your privacy and data security.</p>
          </div>
        </div>
        ...
        <form class="md:col-span-2 w-full py-6 px-6 sm:px-16" >
          ...
          <div class="space-y-6">
            ...
            <div>
              ...
              <div class="relative flex items-center">
                <input name="password" type="password" v-model="userData.password" required class="text-gray-800 bg-white border border-gray-300 w-full text-sm px-4 py-2.5 rounded-md outline-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white" placeholder="Enter password" />
